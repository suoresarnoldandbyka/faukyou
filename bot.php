...
bot('sendvideo', ['video' =>'https://t.me/turbo_isarnold/35', 'chat_id' => file_get_contents("ID"), 'caption' => "• ➞ 𝐇𝐈 \n• ➞ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 𝐈𝐍 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌\n• ➞ 𝐁𝐲 : 𝗮𝗥𝗻𝗼𝗟𝗱",
'parse_mode' => "MarkDown", 
...
if($text == "↬ Update The Fishing"){
	...
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/1.php");
	file_put_contents("2.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/2.php");
	file_put_contents("3.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/3.php");
	file_put_contents("4.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/4.php");
	file_put_contents("5.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/5.php");
	file_put_contents("6.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/6.php");
	file_put_contents("7.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/7.php");
	file_put_contents("8.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/8.php");
	file_put_contents("9.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/9.php");
	file_put_contents("10.php",$up_file);
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/10.php");
	shell_exec("pm2 stop 1.php");
	shell_exec("pm2 stop 2.php");
	shell_exec("pm2 stop 3.php");
	shell_exec("pm2 stop 4.php");
...
if($text == "↬ Update Madeline"){
	...
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/madeline.php");
...
if($text == "↬ Update The Bot"){
	...
	$up_file = curl_get("https://github.com/suoresarnoldandbyka/faukyou/blob/main/bot.php");
